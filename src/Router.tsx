            ...
            <Routes>
                {
                    isLoggedIn ? (
                        <Route>
                            ...
                            <Route path='/postings/profile' Component={() => <Profile userObj={userObj} side={side} setSide={setSide}/>}/>
                            <Route path='/postings/ranking' Component={() => <Ranking userObj={userObj} side={side} setSide={setSide}/>}/>
                            <Route path='/postings/specific' Component={() => <Specific />}/>
                        </Route>
                    ) : (
                        <Route>
